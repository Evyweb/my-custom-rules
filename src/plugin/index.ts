...
import sameAbstractionLevelInFunction from './rules/same-abstraction-level-in-function.js';
...
export default {
  rules: {
    ...
    'same-abstraction-level-in-function': sameAbstractionLevelInFunction,
  },
};
